...
export class Backend implements backendInterface {
    ...
    async getModels(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getModels(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVehicleTypes(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVehicleTypes();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchVehicles(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<Array<Vehicle>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchVehicles(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
